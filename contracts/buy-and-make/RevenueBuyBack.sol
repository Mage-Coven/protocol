...
contract RevenueBuyBack is IRevenueRecipient, Initializable, ImmutableModule {
    ...
    ****************************************/
    ...
    /**
     * @notice Buys reward tokens, eg ZENO, using mAssets like zUSD or mBTC from protocol revenue.
     * @param _mAssets Addresses of mAssets that are to be sold for rewards. eg zUSD and mBTC.
     */
    ...
    ****************************************/
     ...
     * eg USDC/zUSD and wBTC/mBTC exchange rates.
