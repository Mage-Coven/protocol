...
interface SavingsContractIzusdMainnet21Interface
...
export class SavingsContractIzusdMainnet21 extends BaseContract {
  ...
  filters: {
    ...
    Referral(
      ...
      [string, string, BigNumber],
      { referrer: string; beneficiary: string; amount: BigNumber }
    >;
