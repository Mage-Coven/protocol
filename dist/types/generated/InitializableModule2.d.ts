...
interface InitializableModule2Interface extends ethers.utils.Interface {
  functions: {
...
export class InitializableModule2 extends BaseContract {
  ...
  interface: InitializableModule2Interface;
