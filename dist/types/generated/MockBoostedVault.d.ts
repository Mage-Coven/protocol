...
interface MockBoostedVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class MockBoostedVault extends BaseContract {
  ...
  interface: MockBoostedVaultInterface;
