    ...
    outputs: [
      {
        ...
        internalType: "struct MassetStructs.RedeemProps",
        name: "props",
        type: "tuple",
      },
    ],
...
export class BasketManager__factory {
  static readonly abi = _abi;
  static createInterface(): BasketManagerInterface {
    return new utils.Interface(_abi) as BasketManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BasketManager {
    return new Contract(address, _abi, signerOrProvider) as BasketManager;
  }
}
