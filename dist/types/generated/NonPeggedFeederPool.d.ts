...
interface NonPeggedFeederPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class NonPeggedFeederPool extends BaseContract {
  ...
  interface: NonPeggedFeederPoolInterface;
