...
interface InstantProxyAdminInterface extends ethers.utils.Interface {
  functions: {
...
export class InstantProxyAdmin extends BaseContract {
  ...
  interface: InstantProxyAdminInterface;
