...
interface MockStakedTokenWithPriceInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setPriceCoefficient(uint16)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setPriceCoefficient",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "PriceCoefficientUpdated(uint16)": EventFragment;
...
export class MockStakedTokenWithPrice extends BaseContract {
  ...
  interface: MockStakedTokenWithPriceInterface;
  ...
  filters: {
    ...
    PriceCoefficientUpdated(
      newPriceCoeff?: null
    ): TypedEventFilter<[number], { newPriceCoeff: number }>;
