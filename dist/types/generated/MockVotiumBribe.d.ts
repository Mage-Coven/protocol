...
interface MockVotiumBribeInterface extends ethers.utils.Interface {
  functions: {
    "depositBribe(address,uint256,bytes32,uint256)": FunctionFragment;
  ...
  events: {
    "Bribed(address,uint256,bytes32,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Bribed"): EventFragment;
}

export class MockVotiumBribe extends BaseContract {
  ...
  interface: MockVotiumBribeInterface;
