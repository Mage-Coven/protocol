...
interface IBoostedDualVaultWithLockupInterface extends ethers.utils.Interface {
  functions: {
...
export class IBoostedDualVaultWithLockup extends BaseContract {
  ...
  interface: IBoostedDualVaultWithLockupInterface;
