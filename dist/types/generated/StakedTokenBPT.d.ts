...
interface StakedTokenBPTInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "fetchPriceCoefficient",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getProspectivePriceCoefficient",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setBalRecipient",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "FeesConverted(uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "FeesConverted"): EventFragment;
...
export class StakedTokenBPT extends BaseContract {
  ...
  functions: {
    ...
    getProspectivePriceCoefficient(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { newPriceCoeff: BigNumber }>;
  ...
  filters: {
    ...
    PriceCoefficientUpdated(
      newPriceCoeff?: null
    ): TypedEventFilter<[BigNumber], { newPriceCoeff: BigNumber }>;
