...
interface PlatformTokenVendorFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class PlatformTokenVendorFactory extends BaseContract {
  ...
  interface: PlatformTokenVendorFactoryInterface;

  functions: {
    dummy(overrides?: CallOverrides): Promise<[boolean]>;
  };
