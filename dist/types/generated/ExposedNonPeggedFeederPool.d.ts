...
interface ExposedNonPeggedFeederPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "fAssetRedemptionPriceGetter()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "fAssetRedemptionPriceGetter",
    values?: undefined
  ): string;
...
export class ExposedNonPeggedFeederPool extends BaseContract {
  ...
  interface: ExposedNonPeggedFeederPoolInterface;
  ...
  functions: {
    ...
    fAssetRedemptionPriceGetter(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    fAssetRedemptionPriceGetter(overrides?: CallOverrides): Promise<BigNumber>;
