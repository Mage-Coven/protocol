...
interface GamifiedVotingTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class GamifiedVotingToken extends BaseContract {
  ...
  interface: GamifiedVotingTokenInterface;
