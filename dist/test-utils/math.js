...
exports.sum = exports.sqrt = exports.maximum = exports.minimum = exports.createMultiple = exports.applyRatioCeil = exports.applyRatio = exports.applyRatioMassetToBasset = exports.percentToWeight = exports.applyDecimals = exports.simpleToExactAmount = exports.BN = void 0;
...
const simpleToExactAmount = (amount, decimals = constants_1.DEFAULT_DECIMALS) => {
...
const applyDecimals = (inputQuantity, decimals = constants_1.DEFAULT_DECIMALS) => ethers_1.BigNumber.from(10)
    .pow(18 - decimals)
    .mul(inputQuantity);
exports.applyDecimals = applyDecimals;
const percentToWeight = (percent) => exports.simpleToExactAmount(percent, 16);
exports.percentToWeight = percentToWeight;
// How many bAssets is this mAsset worth
const applyRatioMassetToBasset = (input, ratio) => input.mul(constants_1.ratioScale).div(ratio);
exports.applyRatioMassetToBasset = applyRatioMassetToBasset;
// How many mAssets is this bAsset worth
const applyRatio = (bAssetQ, ratio) => ethers_1.BigNumber.from(bAssetQ).mul(ratio).div(constants_1.ratioScale);
...
const sqrt = (value) => {
    const x = ethers_1.BigNumber.from(value);
    let z = x.add(1).div(2);
    let y = x;
